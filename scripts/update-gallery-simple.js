...
// public/images ディレクトリを走査して画像情報を取得（サイズは仮の値を使用）
function scanImagesDirectory() {
  ...
  try {
    ...
    console.log('\nNote: Width and height are set to default values (800x600).');
    console.log('You can manually update these values or use a different approach to get actual dimensions.');
...
module.exports = { scanImagesDirectory };